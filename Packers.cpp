...
#pragma region Menus
                ...
                if ((counter % 3000) == 0)
                {
                    ...
                    if (theInput.getInitialized ())
                    {

                        if (theInput.getProccessedKey (keyboardKeys::Down))
                        {
                            switch (menuState)
                            {
                                case 10:
                        ...
                        if (theInput.getProccessedKey (keyboardKeys::Up))
                        {
                            switch (menuState)
                            {
                                case 10:
                        ...
                        if (theInput.getProccessedKey (keyboardKeys::Left))
                        {
                            if (involved == true)
                            {
                        ...
                        if (theInput.getProccessedKey (keyboardKeys::Right))
                        {
                            if (involved == true)
                            {
                        ...
                        if (theInput.getProccessedKey (keyboardKeys::Return))
                        {
                            switch (menuState)
                            {
                                case 10:
