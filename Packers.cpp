...
int main ()
{
    ...
    // Infobars.h
    TheTitleBar theTitleBar ( areaOne.getDimension (), u8"theTitleBar" );
    gameElements.set ( &theTitleBar );
    gameElements.get ( *theTitleBar.setGetElementId () ).draw ();
    TheGuideBar theGuideBar ( areaOne.getDimension (), u8"theGuideBar" );
            ...
            if ( ( counter % 400000 ) == 0 )
            {
                ...
                if ( GetAsyncKeyState ( VK_RETURN ) )
                {
                    ...
                    case 10:
                        ...
                        insert.colourInserter ( involvedOne->getProcess ( 1 ).action, involvedOne->getMotivation (), involvedOne->getPosition () );
                        menuOne.switcher ();
                        insert.colourInserter ( u8"For now you can be just a nature lover! ^.^", F_bWHITE, { 3, 35 } );
                        insert.colourInserter ( u8"This is a demo representing the idea. ^,^", F_bWHITE, { 3, 36 } );
                        insert.colourInserter ( u8"Please press ESC to end your try.", F_bWHITE, { 3, 37 } );
                        menuState = 0;
                        break;
                    case 11:
...

                {
                    ...
                    if ( GetAsyncKeyState ( VK_ESCAPE ) && ( menuState == 0 ) )
                    {
                        ...
                        menuState = 10;
                        theNarrator.draw ( 2 );
                        insert.colourInserter ( u8"                                           ", { 3, 35 } );
                        insert.colourInserter ( u8"                                         ", { 3, 36 } );
                        insert.colourInserter ( u8"                                 ", { 3, 37 } );
                        menuOne.switcher ();
                    }
                }
            }
