...
TheNarrator::TheNarrator ( std::string name ) :GameElement::GameElement ()
{
    ...
    scenes [1][0] = u8"The spot pointed by the giant is interesting.";
    scenes [1][1] = u8"He lives at a planet full of little creatures.";
    scenes [1][2] = u8"Their history written in stone script is full of hunger.";
...
TheGiant::TheGiant ( std::string name ) :GameElement::GameElement ()
{
